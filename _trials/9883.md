...
pi_other:
  1:
    ...
    affiliation: ifo Institute, LMU Munich, CESifo
  2:
    name: Timo Wochner
    email: wochner@ifo.de
    affiliation: ifo Institute, LMU Munich
  3:
    name: Philipp Heil
    email: heil@ifo.de
    affiliation: ifo Institute, LMU Munich
  4:
    name: Sarah Necker
    email: necker@ifo.de
    affiliation: ifo Institute, FAU Erlangen-Nürnberg
  5:
    name: Sebastian Blesse
    email: Sebastian.Blesse@zew.de
    affiliation: ZEW
  6:
    name: Klaus Gründler
