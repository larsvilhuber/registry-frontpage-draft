...
pi_other:
  1:
    - name: Vincenzo Valori
    - email: vincenzo.valori@unifi.it
    - affiliation: Università degli studi di Firenze
  2:
    - name: Maria Grazia Pazienza
    - email: mariagrazia.pazienza@unifi.it
    - affiliation: Università degli studi di Firenze
  3:
    - name: Domenico  Colucci
    - email: domenico.colucci@unifi.it
    - affiliation: Università degli studi di Firenze
