...
pi_other:
  1:
    name: Bernd Beber
    email: bernd.beber@rwi-essen.eu
    affiliation: RWI - Leibniz Institute for Economic Research
  2:
    name: Macartan Humphreys
    email: macartan.humphreys@wzb.eu
    affiliation: WZB Berlin Social Science Center and Columbia University
  3:
    name: Pheliciah Mwachofi
    email: pmwachofi@poverty-action.org
    affiliation: IPA Nigeria
  4:
    name: Dean Yang
