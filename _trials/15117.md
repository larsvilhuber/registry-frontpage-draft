...
pi_other:
  ...
  2:
    name: Muhammad Asadullah Khawaja
    email: dr_kmasadullah@yahoo.co.uk
    affiliation: King Edward Medical University
  3:
    name: Muhammad Hamad Ali
    email: hamad.alizai@lums.edu.pk
    affiliation: Lahore University of Management Sciences
  4:
    name: Ali Zafar Sheikh
    email: AliZafarMBBS@gmail.com
    affiliation: Lahore General Hospital
  5:
    name: Muhammad Junaid Akhtar
    email: junaid_qmc@yahoo.com
    affiliation: Children's Hospital, Lahore
