---
title: "About"
# hugo.toml sets outputs.page = ["HTML", "BibTeX", "RIS"] for trial detail
# pages; this is a plain doc page (also Kind "page"), so opt back out --
# there's no citation record to export.
outputs: ["HTML"]
---

This is the documentation for the American Economic Association's
...
submission for [pre-results review](http://jde-preresultsreview.org/) at the Journal of Development Economics before beginning data collection.

**If you are searching for results:** Please browse the [registrations](../trials/). More results are always forthcoming!
