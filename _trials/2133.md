...
pi_other:
  1:
    - name: Claire Chase
    - email: 
    - affiliation: Water Practice, World Bank, Washington DC
  2:
    - name: Yolande Coombes
    - email: 
    - affiliation: World Bank, Nairobi, Kenya
  3:
    - name: Mohommed Karama
    - email: 
  ...
  5:
    - name: John Kariuki
    - email: 
    - affiliation: Ministry of Health, Nairobi, Kenya
