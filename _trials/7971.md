...
pi_other:
  - name: Laura Morínigo
    email: laura.morinigo@fundacioncapital.org
    affiliation: Fundación Capital
  - name: Carolina  De Miranda
    email: carolina.miranda@fundacioncapital.org
    affiliation: Fundación Capital
  - name: Franque Grimard
    email: Franque.grimard@mcgill.ca
    affiliation: McGill University
  - name: Tania Insfrán
    email: tania.insfran@fundacioncapital.org
    affiliation: Fundación Capital
  - name: Thomas Kokossou
    email: Thomas.kokossou@mail.mcgill.ca
    affiliation: McGill University
  - name: Jim Engle-Warnick
    email: jim.engle-warnick@mcgill.ca
    affiliation: McGil University
