...
pi_other:
  ...
  2:
    name: Jérémie GIGNOUX
    email: jeremie.gignoux@ens.fr
    affiliation: Paris School of Economics - INRA
  3:
    name: Rick KAMUGISHA
    email: R.kamugisha@cgiar.org
    affiliation: ICRAF
  4:
    name: Monica KARUHANGA BERAHO
    email: mkbkemigisha@gmail.com
    affiliation: Makerere University
  5:
    name: Margaret NAJJINGO MANGHENI
