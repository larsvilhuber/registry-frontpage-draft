...
pi_other:
  1:
    name: Clementine Van Effenterre
    email: c.vaneffenterre@psemail.eu
    affiliation: Paris School of Economics
  2:
    name: Julien Grenet
    email: julien.grenet@ens.fr
    affiliation: Centre National de la Recherche Scientifique - Paris School of Economics
  3:
    name: Marion Monnet
    email: marion.monnet@ipp.eu
