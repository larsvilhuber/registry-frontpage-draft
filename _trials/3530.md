...
pi_other:
  1:
    ...
    - email: apurva.chikhale@ucdconnect.ie
    - affiliation: University College Dublin
  2:
    - name: Kun Wu
    - email: kun.wu1@ucdconnect.ie
    - affiliation: University College Dublin
  3:
    - name: Sheenam Wadhwa
    - email: sheenam.wadhwa@ucdconnect.ie
    - affiliation: University College Dublin
  4:
    - name: Colm Mulcahy
    - email: colm.mulcahy@ucdconnect.ie
    - affiliation: University College Dublin
  5:
    - name: Aisling Burns
    - email: aisling.burns.1@ucdconnect.ie
    - affiliation: University College Dublin
  6:
    - name: Jordan Shelby Eng
    - email: jordan.eng@ucdconnect.ie
    - affiliation: University College Dublin
