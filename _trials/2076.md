...
pi_other:
  1:
    name: Emilio Rojo
    email: erojo@hospitalbenitomenni.org
    affiliation: Hermanas Hospitalarias SCJ Benito Menni CASM
  2:
    name: Maria Jesus San Pío
    email: mjsanpio@federacio.salutmental.org
    affiliation: Federació Salut Mental Catalunya
