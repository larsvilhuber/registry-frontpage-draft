...
pi_other:
  1:
    - name: Xavier Lambin
    - email: xavier.lambin@grenoble-em.com
    - affiliation: Grenoble School of Management
  2:
    - name: Guillaume Chapelle
    - email: guillaume.chapelle@cyu.fr
    - affiliation: Cergy Paris Université
  3:
    - name: Pierre Deschamps
    - email: pierre.deschamps@sofi.su.se
    - affiliation: SOFI (Stockholm University)
  4:
    - name: morgane laouenan
    - email: morgan.laouenan@sciencespo.fr
    - affiliation: CNRS
