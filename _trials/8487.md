...
pi_other:
  - name: Léa  Toulemon
    email: lea.toulemon@ipp.eu
    affiliation: Institut des Politiques Publiques (IPP)
  - name: Delphine  Roy
    email: delphine.roy@ipp.eu
    affiliation: Institut des Politiques Publiques (IPP), DREES
  - name: Thomas  Breda
    email: thomas.breda@psemail.eu
    affiliation: PSE, CNRS, IPP
  - name: Maëlle Stricot
    email: maelle.stricot@psemail.eu
    affiliation: PSE
  - name: Audrey Rain
    email: audrey.rain@ipp.eu
