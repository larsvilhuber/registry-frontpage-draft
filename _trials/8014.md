...
pi_other:
  1:
    name: Addabbo Tindara
    email: tindara.addabbo@unimore.it
    affiliation: Dipartimento di Economia "Marco Biagi"- Unimore
  2:
    name: Chiara Strozzi
    email: chiara.strozzi@unimore.it
    affiliation: Dipartimento di Economia "Marco Biagi"- Unimore
  3:
    name: Carlo Tommasetto
    email: carlo.tomasetto@unibo.it
    affiliation: Dipartimento di Psicologia "Renzo Canestrari" - Unibo
  4:
    name: Francesca Pesciarelli
    email: francesca.pesciarelli@unimore.it
    affiliation: Dipartimento di Scienze Biomediche, Metaboliche e Neuroscienze
  5:
    name: chiara Tasselli
    email: tassellichiara@gmail.com
    affiliation: Dipartimento di Economia "Marco Biagi"- Unimore
