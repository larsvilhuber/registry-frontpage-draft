...
pi_other:
  1:
    name: Thomas Ginn
    email: ginn.thomas@gmail.com
    affiliation: Center for Global Development
  2:
    name: Olivia Woldemikael
    email: woldemikael@g.harvard.edu
    affiliation: Harvard University
  3:
    name: Helidah Ogude-Chambert
    email: helidah.ogude@qeh.ox.ac.uk
    affiliation: University of Oxford
  4:
    name: Robert Hakiza
    email: robert@yarid.org
    affiliation: Young African Refugees for Integral Development
