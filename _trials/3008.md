...
pi_other:
  1:
    name: Sam Sharp
    email: 
    affiliation: Overseas Development Institute (ODI)
  2:
    name: Tracy Ayee
    email: 
    affiliation: 
  3:
    name: Alice Escande
    email: alice.escande@busaracenter.org
    affiliation: Busara Center for Behavioral Economics
  4:
    name: Ariana Keyman
    email: ariana.keyman@busaracenter.org
    affiliation: Busara Center for Behavioral Economics
  5:
    name: Sarah Swanson
    email: sarah.swanson@busaracenter.org
    affiliation: Busara Center for Behavioral Economics
  6:
    name: Mareike Schomerus
    email: m.schomerus@odi.org.uk
    affiliation: Busara Center for Behavioral Economics
