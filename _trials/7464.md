...
pi_other:
  1:
    name: Petra Rybosova
    email: Petra.Rybosova@financnasprava.sk
    affiliation: Tax Authority Slovak Republic
  2:
    name: Berenika Tuzilova
    email: berenika.tuzilova@gmail.com
    affiliation: Prague University of Economics and Business
  3:
    name: Richard Priesol
    email: richard.priesol@mfsr.sk
    affiliation: Institute for Fiscal Policy
  4:
    name: Lubomir Cingl
